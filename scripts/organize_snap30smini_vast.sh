...
TRAIN_JSON_PATH="/root/hcmus/SnapUGC/snapugc_30s_mini_train.json"
VAL_JSON_PATH="/root/hcmus/SnapUGC/snapugc_30s_mini_val.json"
TEST_JSON_PATH="/root/hcmus/SnapUGC/snapugc_30s_mini_test.json"
TRAIN_DIR="/root/hcmus/SnapUGC/data/train"
TEST_DIR="/root/hcmus/SnapUGC/data/test"
OUTPUT_DIR="/root/hcmus/SnapUGC/data_30s_mini"
